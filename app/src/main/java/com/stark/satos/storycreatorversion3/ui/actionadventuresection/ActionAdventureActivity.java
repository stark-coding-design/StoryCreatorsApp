...
import com.stark.satos.storycreatorversion3.firestorefunctionality.AdapterActionAdventure;
...
public class ActionAdventureActivity extends AppCompatActivity implements AdapterActionAdventure.OnNoteListener {

    private FirebaseAuth mAuth = FirebaseAuth.getInstance();
    private FirebaseUser currentUser = mAuth.getCurrentUser();
    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private CollectionReference newPostReference = db.collection("action");
    private AdapterActionAdventure adapter;
    private RecyclerView recyclerView;
    FirestoreRecyclerOptions<NewPostDocumentFields> options;

    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_action_adventure);
        setUpRecyclerView();
    ...
    private void setUpRecyclerView() {
        ...
        adapter = new AdapterActionAdventure(options, this);
        recyclerView = findViewById(R.id.recycler_view_action_adventure);
    ...
    public void onNoteClick(int position) {
        ...
        Intent intent = new Intent(this, ActionAdventureStoryContentForRecyclerItem.class);
        ...
        setStoryContentToView.setGenre("action");
