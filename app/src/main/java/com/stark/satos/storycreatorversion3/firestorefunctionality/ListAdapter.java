...
public class ListAdapter extends FirestoreRecyclerAdapter<NewPostDocumentFields, ListAdapter.ViewHolder> {

    private OnNoteListener mOnNoteListener;

    public ListAdapter(@NonNull @NotNull FirestoreRecyclerOptions<NewPostDocumentFields> options, OnNoteListener onNoteListener) {
        super(options);
        this.mOnNoteListener = onNoteListener;
    }

    @Override
    protected void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position, @NonNull @NotNull NewPostDocumentFields model) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
            ...
            return new ListAdapter.ViewHolder(viewForRecycler, mOnNoteListener);
    }
