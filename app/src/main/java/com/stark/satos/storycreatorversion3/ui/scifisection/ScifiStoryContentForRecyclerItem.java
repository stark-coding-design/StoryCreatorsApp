...
public class ScifiStoryContentForRecyclerItem extends AppCompatActivity {
    ...
    CollectionReference scifiCollectionRef = db.collection("scifi");
    DocumentReference storyIdDocRef = scifiCollectionRef.document(setStoryContentToView.getStoryId());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scifi_story_content_for_recycler_item);
        content = findViewById(R.id.scifi_content_text_view);
        ...
        addToStoryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View root) {
                Intent intent = new Intent(ScifiStoryContentForRecyclerItem.this, AddStoryToMainStoryActivity.class);
                startActivity(intent);
            }
        });
        cancelButton = (Button) findViewById(R.id.cancel_button_scifi);
    ...
    public void swapActivity(){
        Intent intent = new Intent(ScifiStoryContentForRecyclerItem.this, MainActivity.class);
        startActivity(intent);
    }
