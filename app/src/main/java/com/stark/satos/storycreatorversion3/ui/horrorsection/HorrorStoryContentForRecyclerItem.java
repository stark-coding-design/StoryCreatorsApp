...
public class HorrorStoryContentForRecyclerItem extends AppCompatActivity {
    TextView content;
    ...
    CollectionReference horrorCollectionRef = db.collection("horror");
    DocumentReference storyIdDocRef = horrorCollectionRef.document(setStoryContentToView.getStoryId());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_horror_story_content_for_recycler_item);
        content = findViewById(R.id.horror_content_text_view);
        ...
        addToStoryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View root) {
                Intent intent = new Intent(HorrorStoryContentForRecyclerItem.this, AddStoryToMainStoryActivity.class);
                startActivity(intent);
            }
        });

        cancelButton = (Button) findViewById(R.id.cancel_button_horror);
    ...
    public void swapActivity(){
        Intent intent = new Intent(HorrorStoryContentForRecyclerItem.this, MainActivity.class);
        startActivity(intent);
    }
